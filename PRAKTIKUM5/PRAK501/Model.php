<?php
    ...
    if (isset($_POST['tambahmember'])) {
		...
		$tambah = mysqli_query($koneksi,"INSERT INTO member VALUES ('$id_member','$nama_member','$nomor_member','$alamat','$tgl_mendaftar','$tgl_terakhir_bayar')");
		if($tambah){
	...
	if (isset($_POST['editmember'])) {
		...
		$perbarui = mysqli_query($koneksi,"update member set id_member='$id_member', nama_member='$nama_member', nomor_member='$nomor_member', alamat='$alamat', tgl_mendaftar='$tgl_mendaftar', tgl_terakhir_bayar='$tgl_terakhir_bayar' where id_member='$id_member'");
            if ($perbarui) {
